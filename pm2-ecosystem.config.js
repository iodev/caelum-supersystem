  ...
  apps: [
    ...
    // =========================================================================
    {
      ...
      env: {
        ...
        DATABASE_URL: 'postgresql://pim_user:pim_secure_2025!@localhost:15433/pim_database',
      },
      error_file: '/home/rford/caelum/ss/PassiveIncomeMaximizer/logs/pim-error.log',
      out_file: '/home/rford/caelum/ss/PassiveIncomeMaximizer/logs/pim-out.log',
    ...
    // Alpha Vantage - 18D cross-asset signals (f210-f227)
    {
      ...
      error_file: '/home/rford/caelum/ss/senvec/logs/alphavantage-error.log',
    ...
    // SenVec Aggregator - Combines all 4 services into 72D
    {
      ...
      error_file: '/home/rford/caelum/ss/senvec/logs/aggregator-error.log',
